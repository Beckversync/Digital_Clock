...
HD_PWD='C:/Users/Admin/All_in/All_in.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log DigitalClock_12hrs.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DigitalClock_12hrs.tcl
