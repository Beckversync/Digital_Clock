...
HD_PWD='C:/Users/Admin/All_in/All_in.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DigitalClock_12hrs.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DigitalClock_12hrs.tcl -notrace
