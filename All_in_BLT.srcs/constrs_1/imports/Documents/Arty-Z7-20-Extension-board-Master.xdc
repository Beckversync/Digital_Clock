...
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { AM_PM_indicator_led }]; #IO_L19P_T3_34           Sch=CK_IO6
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { clock_mode_indicator_led }]; #IO_L9N_T1_DQS_34        Sch=CK_IO7

## RGB LEDs
set_property -dict { PACKAGE_PIN G17    IOSTANDARD LVCMOS33 } [get_ports { sec_led[4] }]; #IO_L16P_T2_35 Sch=LED4_G
#set_property -dict { PACKAGE_PIN N15    IOSTANDARD LVCMOS33 } [get_ports { led4_r }]; #IO_L21P_T3_DQS_AD14P_35 Sch=LED4_R
set_property -dict { PACKAGE_PIN G14    IOSTANDARD LVCMOS33 } [get_ports {sec_led[5]}]; #IO_0_35 Sch=LED5_B
...
## LEDs on ARTY Z7-20
set_property -dict { PACKAGE_PIN R14    IOSTANDARD LVCMOS33 } [get_ports { sec_led[0] }]; #IO_L6N_T0_VREF_34 Sch=LED0
set_property -dict { PACKAGE_PIN P14    IOSTANDARD LVCMOS33 } [get_ports { sec_led[1] }]; #IO_L6P_T0_34 Sch=LED1
set_property -dict { PACKAGE_PIN N16    IOSTANDARD LVCMOS33 } [get_ports { sec_led[2] }]; #IO_L21N_T3_DQS_AD14N_35 Sch=LED2
set_property -dict { PACKAGE_PIN M14    IOSTANDARD LVCMOS33 } [get_ports { sec_led[3] }]; #IO_L23P_T3_35 Sch=LED3

## LEDs on Extension board
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { an[0] }]; #IO_L21P_T3_DQS_34        Sch=CK_IO8
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { an[1]  }]; #IO_L21N_T3_DQS_34        Sch=CK_IO9
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { an[2]  }]; #IO_L9P_T1_DQS_34         Sch=CK_IO10
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { an[3]  }]; #IO_L19N_T3_VREF_34       Sch=CK_IO11
...
## Buttons
set_property -dict { PACKAGE_PIN D19    IOSTANDARD LVCMOS33 } [get_ports { btn0_clock }]; #IO_L4P_T0_35 Sch=BTN0
set_property -dict { PACKAGE_PIN D20    IOSTANDARD LVCMOS33 } [get_ports { btn1_up }]; #IO_L4N_T0_35 Sch=BTN1
set_property -dict { PACKAGE_PIN L20    IOSTANDARD LVCMOS33 } [get_ports { btn2_down }]; #IO_L9N_T1_DQS_AD3N_35 Sch=BTN2
set_property -dict { PACKAGE_PIN L19    IOSTANDARD LVCMOS33 } [get_ports { btn3_toggle }]; #IO_L9P_T1_DQS_AD3P_35 Sch=BTN3
...
## Pmod Header JB
#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { AM_PM_indicator_led }]; #IO_L8P_T1_34 Sch=JB1_P (Pin 1)
#set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { clock_mode_indicator_led }]; #IO_L8N_T1_34 Sch=JB1_N (Pin 2)
